...
def parse_args():
    ...
    # ADD (Zehao Wang @ Jan 13 2021) : train answer head only setting
    parser.add_argument("--ansHeadOnly", dest='ans_head_only', action='store_const', default=False, const=True)
    parser.add_argument("--txtOnly", dest='txt_only', action='store_const', default=False, const=True)
    parser.add_argument("--warmup", dest='warmup', default=0.1, type=float)
    # Parse the arguments.
